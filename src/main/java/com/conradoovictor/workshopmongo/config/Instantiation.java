...
import com.conradoovictor.workshopmongo.dto.AuthorDTO;
import com.conradoovictor.workshopmongo.dto.CommentDTO;
import com.conradoovictor.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viagem mano!", LocalDate.parse("2018-03-23"), new AuthorDTO(alex));
